  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-10 lg:gap-6">
        {/* Image card */}
        <Card className="overflow-hidden border-border p-0 lg:col-span-4">
          <Skeleton className="h-[320px] w-full rounded-none sm:h-[420px] lg:h-[640px]" />
        </Card>
